play_game([Board,Trees1,Trees2,54,Turn], Player1, Player2) :-
    ...
    valid_moves(InitialState,null,ValidMoves),
    (Turn == 1 ->
...
play_game(GameState, (PlayerNumber1, PlayerName1, Goal1), (PlayerNumber2, PlayerName2, Goal2)):-
    ...
    get_trees_in_board(Board,TreesInBoard),
    choose_tree_in_board((Tree,OldCoordinates),TreesInBoard),
    ...
    move(MiddleState,((Tree,null),OldCoordinates),TurnState),
    change_turn(TurnState,FinalState),
